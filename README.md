...
#### :file_cabinet: Lesson-1
-  основні типи даних в js, основи функцій, розгалуження та цикли
  
#### :eyeglasses: Lesson-2
- масиви, особливості їх роботи і базові методи,
- використання циклу for … of
- області видимості
- обʼєкти, їх створення, додавання властивостей та змінення їх значень,перебирання, звернення до властивостей чи методів обʼєкта
- масиви однотипних обʼєктів, spread і rest.
